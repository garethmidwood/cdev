...
class SearchPluginCommand extends ConfigurationCommand
{
    ...
    protected function configure()
    {
        ...
        $this->setDescription('Searches cdev plugins');
        ...
        $this->addArgument('packages', InputArgument::IS_ARRAY, 'The packages to search for');
    }
     ...
     * @return type
     */
    private function searchPlugins($package = null)
    {
        $packageToFind = isset($package) ? $package : $this->_package;

        $path = \Creode\Cdev\Plugin\Manager::getPluginDir();

        $this->_composer->search($path, $packageToFind, ['-t', 'cdev-plugin']);
    }
