...
{
    const VERSION_URL = 'https://garethmidwood.github.io/cdev/downloads/cdev.version';

    const PHAR_URL = 'https://garethmidwood.github.io/cdev/downloads/cdev.phar';

    const PACKAGE_NAME = 'creode/cdev';

    const FILE_NAME = 'cdev.phar';
